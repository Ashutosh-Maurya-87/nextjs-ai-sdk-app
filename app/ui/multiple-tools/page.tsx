...
export default function MultiToolChatPage() {
                                                                ...
                                                                case "input-streaming":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-tool`}>
                                                                            <div className="text-sm text-blue-400 mb-2">Receiving location request...</div>
                                                                ...
                                                                case "input-available":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-tool-${index}`}>
                                                                            <div className="text-sm text-gray-400">Getting locations for {part.input.name}...</div>
                                                                        </div>
                                                                    );
                                                                case "output-available":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-${index}`}>
                                                                            <div className="text-sm font-bold text-emerald-400 mb-1">Location Found:</div>
                                                        ...
                                                        {(() => {
                                                            switch (part.state) {
                                                                ...
                                                                case "input-available":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-tool-${index}`}>
                                                                            <div className="text-sm text-gray-400">Getting weather data for {part.input.city}...</div>
                                                                        </div>
                                                                    );
                                                                case "output-available":
                                                                    return (
            ...
            <div className="w-full pb-8 pt-4 bg-[#131314] border-t border-gray-800">
                <div className="max-w-2xl mx-auto px-4">
                    <ChatInput
                        ...
                        placeholderText="Type the name of city..."
                    />
                </div>
            </div>
        </main>

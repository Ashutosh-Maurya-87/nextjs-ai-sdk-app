                                                                ...
                                                                case "output-available":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-${index}`}>
                                                                            ...
                                                                            <div className="text-gray-200">{part.output.location.name}</div>
                                                                            <div className="text-gray-200">{part.output.current.temp_c}</div>
                                                                            <div className="text-gray-200">{part.output.current.condition.text}</div>
                                                                        </div>
                                                                    );
                                                                case "output-error":
                                                                    return (

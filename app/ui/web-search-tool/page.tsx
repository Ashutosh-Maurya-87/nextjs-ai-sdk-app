                                                                ...
                                                                case "input-streaming":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-tool`}>
                                                                            <div className="text-sm text-blue-400 mb-2">Preparing to search...</div>
                                                                        </div>
                                                                    );
                                                                case "input-available":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-tool-${index}`}>
                                                                            <div className="text-sm text-gray-400">Searching the web...</div>
                                                                        </div>
                                                                    );
                                                                ...
                                                                case "output-error":
                                                                    return (
                                                                        <div key={`${msg?.id}-getWeather-${index}-tool`} className="text-red-400 text-sm">
                                                                            <span className="font-bold">Error on Web Search Failed:</span> <div>{part.errorText}</div>
                                                                        </div>
                                                                    );
                                                                default:
                                                                    return null;
